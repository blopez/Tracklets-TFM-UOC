...
def main():
    ...
    try:
        ...
        ### case with no dangers
        
        # whatever
        bp = blueprint_library.filter('prius')[0]
        ...
        #spawnPoint = carla.Transform(carla.Location(x=-29.21,y=128.68, z=0.598), carla.Rotation(pitch=0.0, yaw=180.0, roll=0.000000))
        #vehicle = world.spawn_actor(bp, spawnPoint)
        #vehicle_list.append(vehicle)
        ...
        print("Sleeping")
        time.sleep(20)
        print("Continuing to put charger")
        
        ### end case with no dangers
