...
def main():
    ...
    try:
        ...
        spawn_camera(cameraId=1, world=world, camera_bp=camera_bp, x=-60.423583, y=123.316581, z=1.886553, pitch=-20, yaw=-30, generate_images=generate_images)
        
        # spawning Camera2 by position
        spawn_camera(cameraId=2, world=world, camera_bp=camera_bp, x=-34.661411, y=123.436012, z=5.335992, pitch=-34.902976989746094, yaw=-168.395263671875, generate_images=generate_images)
